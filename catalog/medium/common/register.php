...
define('REGISTER_ERROR_NICK_LENGTH',-1);
define('REGISTER_ERROR_NICK_UNIQUE',-2);
define('REGISTER_ERROR_EMAIL_UNIQUE',-3);
define('REGISTER_ERROR_EMAIL_FORMAT',-4);
define('REGISTER_ERROR_PHONE_FORMAT',-5);
define('REGISTER_ERROR_PHONE_UNIQUE',-6);
define('REGISTER_ERROR_PASSWORD_LENGTH',-7);
define('REGISTER_ERROR_OTHER',0);
